...
resource "aws_cloudfront_distribution" "default" {
  ...
  dynamic "origin_group" {
    ...
    content {
      origin_id = origin_group.value.origin_id != "" ? origin_group.value.origin_id : "${module.this.id}-group[${origin_group.key}]"
  ...
  default_cache_behavior {
    ...
    target_origin_id           = var.target_origin_id != "" ? var.target_origin_id : local.origin_id
